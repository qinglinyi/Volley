...
import com.github.volley_examples.toolbox.SSLSocketFactoryEx;

/**
 * Demonstrates how to execute HTTPS request against server with self-signed
 * certificate.
 * 
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSimpleRequest.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 绕过SSL 认证
                RequestQueue queue = Volley.newRequestQueue(Act_SsSslHttpClient.this,
                        new ExtHttpClientStack(SSLSocketFactoryEx.getNewHttpClient()));
