...
/**
 * Demonstrates how to use external HttpClient. You may want this approach if
 * you need to use newer version of HttpClient. Basically this demo does exactly
 * the same as {@see Act_SimpleRequest} but uses HttpClient 4.2.x. For this
 * example to work you will need khandroid-httpclient-4.2.3.jar which resides in
 * libs/
 * 
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSimpleRequest.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // Usually getting the request queue shall be in singleton like
                // in {@see Act_SimpleRequest}
                ...
                StringRequest myReq = new StringRequest(Method.GET, "http://www.google.com/",
