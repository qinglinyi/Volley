...
/**
 * Demonstrates how to send GET and POST parameters. Values of the EditText
 * fields are send to the server, they are added and the sum is returned as
 * result. If you use {@see ExtHttpClientStack} as in {@see Act_NewHttpClient}
 * you may use URIBuilder (which is present only in newer versions of
 * HttpClient)
 * 
            ...
            public void onClick(View v) {
                ...
                if (num1 != null && !num1.equals("") && num2 != null && !num2.equals("")) {
                    String uri = String.format(
                            "http://ave.bolyartech.com/params.php?param1=%1$s&param2=%2$s", num1,
                            num2);
